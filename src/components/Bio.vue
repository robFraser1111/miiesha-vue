<template>
    <div class="bio">
        ...
        <p>
            ...
            <br><br>
            Miiesha hails from the small Aboriginal community of Woorabinda in Central Queensland. Since making her debut in mid-2019, Miiesha has released a string of mesmerising singles – ‘Black Privilege’, ‘Drowning’, ‘Twisting Words’ and ‘Hold Strong’. These songs later came together as part of her fearless debut album ‘Nyaaringu’, which was one of 2020’s most affecting and critically lauded albums, nominated for five ARIA awards including Best Female and Breakthrough Artist Miiesha won the Best Soul/R&amp;B ARIA award.
        </p>
    </div>
</template>
