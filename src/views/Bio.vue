<template>
    ...
    <br><br>
    A strong, proud Anangu/Torres Strait Islander woman, Miie-sha (Pronounced My-ee-sha) released her debut collection of songs entitled Nyaaringu in 2020. Meaning ‘what hap-pened' in Pitjantjatjara language, Nyaaringu explores the stories and the strength Miiesha inherited from her late Grandmother, whose interludes narrate the project. Since its release, Nyaaringu has not only garnered critical ac-claim, but received the 2020 ARIA for Best Soul/RnB Re-lease, a QLD Music Award, a NIMA, and went on to top mul-tiple Album of the Year lists.
    <br><br>
    ...
    <br><br>
    With a voice that showcases vulnerability and strength, often in the one breath, Miiesha sings of her people, her community and her story with the raw emotion of lived ex-perience. She weaves together the personal and political so tightly, the listener begins to understand just how in-separable they are for a young Aboriginal woman.
    <br><br>
    <br><br>
