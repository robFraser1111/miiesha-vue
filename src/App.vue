    ...
    <div id="app" :style="{ backgroundImage: `url('${background}')` }">
        <div class="menu">
            <a href="/">
                <img
                    class="logo"
                    src="~@/assets/miiesha-logo-01.png"
                    alt="Miiesha"
                />
            </a>
            <ul>
        ...
        <div id="footer">
            <ul class="social-icons">
                <a
                    href="https://open.spotify.com/artist/1ehGGQnc7E28DNwhvnFuyL"
                >
            ...
            <p>
                <small>
                    Photography by
                    <a href="https://www.colebennetts.com.au/" target="_blank"
                        >Cole Bennetts</a
                    >
                    <br />
                    Website powered by
...
@font-face {
    ...
    src: local("Varela Round"),
        url(./assets/VarelaRound-Regular.ttf) format("truetype");
}
